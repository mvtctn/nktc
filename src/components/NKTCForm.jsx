...
export default function NKTCForm({
  ...
  const handleExportAllWord = () => {
    ...
    onToast('Đang kết hợp và xuất toàn bộ nhật ký...');
    try {
      ...
      {activeTab === 'input' && (
        ...
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '18px', maxWidth: '850px', margin: '0 auto', width: '100%' }}>
          <div className="panel-header" style={{ marginBottom: '0' }}>
            <h3 className="panel-title"><FileText size={18} /> Giao diện Nhập liệu Nhật ký thi công</h3>
          </div>

          {/* Combined Date & Weather Options Row */}
          <div className="input-row">
            <div className="form-group">
              <label className="form-label"><Calendar size={14} /> Ngày thi công</label>
              <input
                type="date"
          ...
          {/* Manpower Input */}
          <div className="form-group">
            <label className="form-label"><Users size={14} /> Số lượng công nhân (Điền số)</label>
            <input
              type="number"
              min="0"
              className="form-control"
          ...
          {/* Notes */}
          <div className="form-group">
            <label className="form-label"><MessageSquare size={14} /> Vướng mắc, chờ mặt bằng, kiến nghị</label>
            <textarea
              className="form-control"
              ...
              {actionsMenuOpen && (
                <div className="glass-card" style={{
                  ...
                  >
                    ...
                    <span>Xuất trang hiện tại (.docx)</span>
                  </button>

                  <button 
                    type="button" 
                    onClick={() => { handleExportAllWord(); setActionsMenuOpen(false); }} 
                    className="menu-item-action"
                  >
                  ...
                  <button 
                    type="button" 
                    onClick={() => { handleCopyJSON(); setActionsMenuOpen(false); }} 
                    className="menu-item-action"
                  >
                    <Copy size={14} />
                  ...
                  <button 
                    type="button" 
                    onClick={() => { handleDownloadJSON(); setActionsMenuOpen(false); }} 
                    className="menu-item-action"
                  >
                    <Download size={14} />
